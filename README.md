...
- 🔗 **LinkedIn:** <a href="https://linkedin.com/in/haneul-jang-1b8b9a190/" target="_blank">Haneul Jang</a>
...
- 🎓 **Every AIdu** – AI-powered SAT grammar question generator using rule-based NLP + T5 fine-tuning
- ⚡️ **Surplus Energy Analysis** – Data-driven analysis of electricity surplus in NYC and credit refund system design using weather + consumption data
- 📉 **User Retention Dashboard** – Built a Python + SQL analytics pipeline for tracking DAU, churn rate, and LTV in an EdTech product
